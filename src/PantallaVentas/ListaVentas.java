...
import alertas.principal.AlertaV;
import alertas.principal.AlertaV1;
...
public class ListaVentas extends javax.swing.JInternalFrame {
    ...
    private void eliminarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarTodoActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            AlertaV1 wa = new AlertaV1(new JFrame(), true);
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                AlertaV wa = new AlertaV(new JFrame(), true);
                wa.id.setText(this.tabla.getValueAt(fila, 0).toString());
                wa.Titulo.setText("¿ESTAS SEGURO?");
                wa.Mensaje.setText("SE BORRARAN TODAS LAS VENTAS");
                wa.Mensaje1.setText("ASOCIADAS A ÉSTE CÓDIGO");
                wa.setVisible(true);
            }
        }
    ...
    private void corteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_corteActionPerformed
        new ModalCorteDelDia(new JFrame(), true).setVisible(true);
