...
public class Ventas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cash-register.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/campo-importe.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/campo-cambio.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/campo-cliente.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/campo-calendario.png"))); // NOI18N
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 160, -1, -1));

        btnVender1.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/logoVentas.png"))); // NOI18N
        ...
        quitar.setBackground(new java.awt.Color(0, 0, 0));
            ...
            if (this.txtImporte.getText().equals("")) {
                ...
                if (total > 0.0) {
                    if (recibe > total) {
                        ...
                        AlertaError er = new AlertaError(new JFrame(), true);
                        er.Titulo.setText("OOPS...");
                        er.Mensaje.setText("INGRESA UNA CANTIDAD");
                        er.Mensaje1.setText("VALIDA");
                        er.setVisible(true);
                    }
                } else {
                    AlertaError er = new AlertaError(new JFrame(), true);
                    er.Titulo.setText("OOPS...");
                    er.Mensaje.setText("IMPOSIBLE REALIZAR");
                    er.Mensaje1.setText("LA OPERACIÓN");
                    er.setVisible(true);
                }
            }
        }
    ...
    private void btnVender1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVender1ActionPerformed
        new PantallaVentas.Productos(new JFrame(), true).setVisible(true);
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        if (this.tablaVentas.getRowCount() < 1) {
            ...
            er.Titulo.setText("OOPS...");
            er.Mensaje.setText("IMPOSIBLE REALIZAR");
            er.Mensaje1.setText("LA VENTA");
            er.setVisible(true);
        } else {
            PantallaVentas.Sentencias s = new Sentencias();
            int contador = 0;
            for (int i = 0; i < this.tablaVentas.getRowCount(); i++) {
                ...
                int opcion = PantallaVentas.Opciones.registrar(s);
                if (opcion != 0) {
                    contador++;
                }
            }
            ...
            if (contador == this.tablaVentas.getRowCount()) {
                ...
                sa.Mensaje.setText("VENTA REALIZADA CON");
                sa.Mensaje1.setText("ÉXITO");
                sa.setVisible(true);
            }
        }
