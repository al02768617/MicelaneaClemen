 ...
 * @author davidramos
 */
public class AlertaV extends javax.swing.JDialog {
     ...
     */
    public AlertaV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = Opciones.eliminar(Integer.parseInt(AlertaV.id.getText()));
        if (elimina != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaV dialog = new AlertaV(new javax.swing.JFrame(), true);
