 ...
 * @author davidramos
 */
public class AlertaP extends javax.swing.JDialog {
     ...
     */
    public AlertaP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaP dialog = new AlertaP(new javax.swing.JFrame(), true);
