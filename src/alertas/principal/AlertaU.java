 ...
 * @author davidramos
 */
public class AlertaU extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AlertaU
     */
    public AlertaU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = Opciones.eliminar(Integer.parseInt(AlertaU.id.getText()));
        if (elimina != 0) {
            Opciones.listar("");
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaU dialog = new AlertaU(new javax.swing.JFrame(), true);
