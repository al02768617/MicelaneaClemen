 ...
 * @author davidramos
 */
public class AlertaG extends javax.swing.JDialog {
     ...
     */
    public AlertaG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = Opciones.eliminar(Integer.parseInt(AlertaG.id.getText()));
        if (elimina != 0) {
            Opciones.listar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaG dialog = new AlertaG(new javax.swing.JFrame(), true);
