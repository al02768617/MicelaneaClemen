...
import PantallaVentas.Opciones;

/**
 *
 * @author davidramos
 */
public class AlertaV1 extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AlertaV
     */
    public AlertaV1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, -1, 155));

        Titulo.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        Titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Titulo.setText("Titulo");
        panel2.add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 185, 366, 32));
        ...
        panel2.add(Mensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 241, 366, -1));
        ...
        panel2.add(Mensaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 278, 366, -1));
        ...
        panel2.add(aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 317, 182, 53));
        ...
        panel2.add(cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 317, 174, 53));

        id.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        id.setText("id");
        panel2.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 11, 30, -1));

        getContentPane().add(panel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 390));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = Opciones.eliminar(Integer.parseInt(AlertaV1.id.getText()));
        if (elimina != 0) {
            ...
            sa.Mensaje.setText("SE HA ELIMINADO EL");
            sa.Mensaje1.setText("REGISTRO DE LA VENTA");
            sa.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaV1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaV1 dialog = new AlertaV1(new javax.swing.JFrame(), true);
