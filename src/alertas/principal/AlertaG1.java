 ...
 * @author davidramos
 */
public class AlertaG1 extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AlertaG
     */
    public AlertaG1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panel1.add(Mensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 241, 366, -1));
        ...
        panel1.add(Mensaje1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 278, 366, -1));
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = Opciones.eliminar(Integer.parseInt(AlertaG1.id.getText()));
        if (elimina != 0) {
            Opciones.listar("");
            ...
            sa.Mensaje.setText("SE HA ELIMINADO UN");
            sa.Mensaje1.setText("REGISTRO");
            sa.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaG1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaG1 dialog = new AlertaG1(new javax.swing.JFrame(), true);
