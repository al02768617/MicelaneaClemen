 ...
 * @author davidramos
 */
public class AlertaP1 extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AlertaP
     */
    public AlertaP1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaP1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaP1 dialog = new AlertaP1(new javax.swing.JFrame(), true);
